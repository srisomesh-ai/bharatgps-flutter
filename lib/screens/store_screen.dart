    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _contactBtn(Icons.email_outlined, 'Send Email', const Color(0xFF1A73E8), () => _sendEmail(email, title, message)),
          const SizedBox(height: 10),
          _contactBtn(Icons.chat, 'Send WhatsApp', const Color(0xFF25D366), () => _sendWhatsApp(message)),
          const SizedBox(height: 10),
          _contactBtn(Icons.call, 'Call Us', AppColors.teal, _call),
        ]),
      ),
    );
  }
